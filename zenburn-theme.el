...
;;;;; dired+
   ...
   `(diredp-date-time ((t (:foreground ,zenburn-red))))
   `(diredp-deletion ((t (:foreground ,zenburn-yellow))))
   `(diredp-deletion-file-name ((t (:foreground ,zenburn-magenta))))
   `(diredp-dir-heading ((t (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
   `(diredp-dir-priv ((t (:foreground ,zenburn-cyan :background ,zenburn-bg))))
   `(diredp-exec-priv ((t (:foreground ,zenburn-red :background ,zenburn-bg))))
   `(diredp-executable-tag ((t (:foreground ,zenburn-green+1))))
   `(diredp-file-name ((t (:foreground ,zenburn-blue))))
   `(diredp-file-suffix ((t (:foreground ,zenburn-blue-3))))
   `(diredp-flag-mark ((t (:foreground ,zenburn-yellow))))
   `(diredp-flag-mark-line ((t (:foreground ,zenburn-orange))))
   `(diredp-ignored-file-name ((t (:foreground ,zenburn-fg-1))))
   `(diredp-link-priv ((t (:foreground ,zenburn-yellow :background ,zenburn-bg))))
   `(diredp-mode-line-flagged ((t (:foreground ,zenburn-yellow))))
   `(diredp-mode-line-marked ((t (:foreground ,zenburn-orange))))
   `(diredp-no-priv ((t (:foreground ,zenburn-fg :background ,zenburn-bg))))
   `(diredp-number ((t (:foreground ,zenburn-green+1))))
   `(diredp-other-priv ((t (:foreground ,zenburn-yellow-1 :background ,zenburn-bg))))
   `(diredp-rare-priv ((t (:foreground ,zenburn-red-1 :background ,zenburn-bg))))
   `(diredp-read-priv ((t (:foreground ,zenburn-green :background ,zenburn-bg))))
   `(diredp-symlink ((t (:foreground ,zenburn-yellow))))
   `(diredp-write-priv ((t (:foreground ,zenburn-magenta :background ,zenburn-bg))))
;;;;; ediff
...
;;;;; org-mode
   ...
   `(org-mode-line-clock ((t (:foreground ,zenburn-magenta :box (:line-width -1 :style released-button)))))
